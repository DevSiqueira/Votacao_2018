	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				$result_candidato = "SELECT * FROM candidatos WHERE candidatura = 'g'";
				...
				while($row_candidato = mysqli_fetch_assoc($resultado_candidato)){
					...
					<div class="col-sm-6 col-md-4">
						...
						<div class="descricao">
									<a href="votar.php?id_candidato=<?php echo $row_candidato['id_candidatos'];?>&prox_tipo=presidente" class="btn btn-success">
										Votar
									</a>
